export default function About() {
  return (
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
      ...
      <p>
        ✨ Features
        🔥 Trending & Top Rated: Stay updated with the latest trending and highest-rated movies.
        📝 Movie Details: View detailed information about any movie including ratings, description, release date, and more.
        ❤️ Favorites: Create your own list of favorite movies to revisit anytime (requires login).
        🔍 Search: Easily find movies and shows by title.
      </p>

      <p>
        Our website is designed to provide you with a comprehensive database of
        movies from all around the world. Our movie database is constantly updated with new
